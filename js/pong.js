...
Silhkan Klik Dimana Saja Untuk Memulai Permainan`);
...
class Pong {
  constructor(canvas) {
    ...
    this.CHARS = [
      ...
      context.fillStyle = "rgb(60, 112, 255)";
  ...
  draw() {
    this._context.fillStyle = "rgb(3, 35, 122)";
  ...
  drawRect(rect) {
    this._context.fillStyle = "rgb(60, 112, 255)";
